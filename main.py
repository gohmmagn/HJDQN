...
parser.add_argument('--loopStart', required=False, default=0, type=int)
...
for actor_lri in actor_lr:
  for critic_lri in critic_lr:
      for taui in tau:
          for sigmai in sigma:
              hyper_pars_ddpg.append([actor_lri, critic_lri, taui, sigmai])
